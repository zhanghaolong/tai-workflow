...
@Component
public class FailOnceActivityForOpenAPI implements Activity {
    ...
    public ActivityExecutionResult invoke(WorkflowContext context) throws InterruptedException {
        ...
        return ActivityExecutionResult.ofSucceeded(
                Map.of(FailOnceActivityForOpenAPI.class.getSimpleName(), LocalDateTime.now().format(DateTimeFormatter.ISO_LOCAL_DATE)));
    }
