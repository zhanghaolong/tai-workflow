...
@Component
public class FailOnceActivityForStartWithSameToken implements Activity {
    ...
    public ActivityExecutionResult invoke(WorkflowContext context) throws InterruptedException {
        ...
        return ActivityExecutionResult.ofSucceeded(
                Map.of(FailOnceActivityForStartWithSameToken.class.getSimpleName(), LocalDateTime.now().format(DateTimeFormatter.ISO_LOCAL_DATE)));
    }
